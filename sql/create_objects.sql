--Таблица содержащая информацию о локации
...
--Таблица содержащая справочную информацию о валютах
...
--Таблица содержащая справочную информацию о работадателях
...
--Таблица содержащая информаци о вакасиях
...
-- Создание функции для триггера. Функция будет использоваться в триггере для предотвращения вставки дубликатов в таблицу VACANCY
...
-- Создание триггера на таблицу vacancy, на основе функции prevent_duplicate_insert()
